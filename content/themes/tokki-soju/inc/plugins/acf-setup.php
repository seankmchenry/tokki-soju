      ...
      'layouts' => array (
        array (
          ...
          'sub_fields' => array (
            ...
            array (
              'key' => 'field_59492ea17cd24',
              'label' => 'Section ID',
              'name' => 'section_id',
              'type' => 'text',
              'instructions' => 'Enter an ID for the section. Please use only lowercase letters and hyphens (for spaces). Try to keep it short.',
              'required' => 1,
              'conditional_logic' => 0,
              'wrapper' => array (
                'width' => '',
